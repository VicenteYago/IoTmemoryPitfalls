Based on code of [bblanchon/cpp4arduino](https://github.com/bblanchon/cpp4arduino)

In order to compile the code, add the `memoryInfo/` folder to  `/Arduino/libraries/`

Adding support for other core requires adding a new variant in
the folder [`memoryInfo/Ports`](memoryInfo/Ports/) and to include the file in
[memoryInfo/Ports/MemoryInfo.cpp](memoryInfo/Ports/MemoryInfo.cpp).
